...
\[
\Phi_C = \left(C, -D\right) \left(\begin{matrix} e\\f\end{matrix}\right) \qquad \overset{\mathcal{C}}{\implies}\qquad
\hat{\Phi}_C(s) = \left(C, -D\right) \left(\begin{matrix} \hat{e}\\\hat{f}\end{matrix}\right) 
\] 
up to a constant.
}
\end{frame}
